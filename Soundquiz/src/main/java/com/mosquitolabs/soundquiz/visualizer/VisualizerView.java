...
import com.mosquitolabs.soundquiz.visualizer.renderer.Renderer;
...
//    invalidate();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBytes != null) {
            ...
            com.mosquitolabs.soundquiz.visualizer.AudioData audioData = new com.mosquitolabs.soundquiz.visualizer.AudioData(mBytes);
        ...
        if (mFFTBytes != null) {
            ...
            com.mosquitolabs.soundquiz.visualizer.FFTData fftData = new FFTData(mFFTBytes);
            for (Renderer r : mRenderers) {
